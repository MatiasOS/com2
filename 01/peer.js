...
const run = async () => {
  ...
  const node = await Libp2p.create({
    ...
    addresses: {
      listen: [
        `/dns4/wrtc-star1.par.dwebops.pub/tcp/443/wss/p2p-webrtc-star/p2p/${PEER_B.id}`
      ],
    },
    config: {
      transport: {
